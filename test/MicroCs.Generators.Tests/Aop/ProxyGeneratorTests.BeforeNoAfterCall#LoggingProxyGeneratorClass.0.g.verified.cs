...
partial class LoggingProxyGeneratorClass
{
    ...
    public LoggingProxyGeneratorClass(global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface iProxyGeneratorInterface, global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.LoggingInterceptors interceptors)
    {
    ...
    static LoggingProxyGeneratorClass()
    {
        ...
        IProxyGeneratorInterface_TargetType_Cache = typeof(global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface);
    ...
    private readonly global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface iProxyGeneratorInterface;
    private const string IProxyGeneratorInterface_TargetType_Name = nameof(global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface);
    private static readonly System.Type IProxyGeneratorInterface_TargetType_Cache;
    private const string MyMethod_0_Name = nameof(global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface.MyMethod);
    private static readonly System.Reflection.MethodInfo MyMethod_0_Cache;
    void global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface.MyMethod()
    {
    ...
    private const string MyMethod_1_Name = nameof(global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface.MyMethod);
    private static readonly System.Reflection.MethodInfo MyMethod_1_Cache;
    string global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface.MyMethod(string input1, int input2)
    {
        var parameters = new object? []
        {
            input1,
    ...
    private const string MyMethod_2_Name = nameof(global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface.MyMethod);
    private static readonly System.Reflection.MethodInfo MyMethod_2_Cache;
    (string, System.DateTime) global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface.MyMethod(string input1, System.DateTime input2)
    {
        var parameters = new object? []
        {
            input1,
    ...
    private const string MyMethod_3_Name = nameof(global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface.MyMethod);
    private static readonly System.Reflection.MethodInfo MyMethod_3_Cache;
    async System.Threading.Tasks.Task global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface.MyMethod(int input1, System.Threading.CancellationToken cancel)
    {
        var parameters = new object? []
        {
            input1,
    ...
    private const string MyMethod_4_Name = nameof(global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface.MyMethod);
    private static readonly System.Reflection.MethodInfo MyMethod_4_Cache;
    async System.Threading.Tasks.Task<string> global::MicroCs.Generators.Lib.Samples.BeforeNoAfterCall.IProxyGeneratorInterface.MyMethod(int input1, string? input2, System.Threading.CancellationToken cancel)
    {
        var parameters = new object? []
        {
            input1,
